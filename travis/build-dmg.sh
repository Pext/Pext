...
bash ./create-dmg --volname "Pext" --volicon "$BUILD_DIR/Pext.app/Contents/Resources/usr/local/pext/images/scalable/pext.icns" --window-pos 200 120 --window-size 800 400 --icon-size 100 --icon Pext.app 200 190 --hide-extension Pext.app --app-drop-link 600 185 Pext.dmg "$BUILD_DIR"/
